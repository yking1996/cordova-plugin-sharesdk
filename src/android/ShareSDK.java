...
public class ShareSDK extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if ("share".equals(action)) {
            showShare(args.optString(0, ""), args.optString(1, ""), args.optString(2, ""), args.optString(3, ""),
                    callbackContext);
    ...
    // LOCAL METHODS
    // --------------------------------------------------------------------------
    private void showShare(String title, String content, String image, String url,
